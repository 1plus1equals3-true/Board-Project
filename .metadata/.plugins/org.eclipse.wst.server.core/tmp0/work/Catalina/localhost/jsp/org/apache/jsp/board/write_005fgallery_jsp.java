 ...
 * Generated at: 2025-09-26 05:32:10 UTC
...
public final class write_005fgallery_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write(".write-form .write_sub,\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write(".write-form .write_sub:hover {\r\n");
...
if(login_id == null || login_id.equals(""))
{
	...
	return;
      ...
      out.write("<form name=\"write_form\" action=\"../board_proc/write_gallery_proc.jsp\" method=\"post\" enctype=\"multipart/form-data\" class=\"write-form\">\r\n");
      out.write("	<table>\r\n");
      out.write("		\r\n");
      out.write("		<tr>\r\n");
      out.write("			<td>제목</td>\r\n");
      ...
      out.write("				<input type=\"button\" class=\"write_sub\" value=\"작성\" onclick=\"gallery_submit()\">\r\n");
      ...
      out.write("    const file_total = 10; // 파일 업로드 제한 수\r\n");
      out.write("    const file_limit = file_total +1;\r\n");
      out.write("\r\n");
      ...
      out.write("                // 경고창을 띄우고\r\n");
      out.write("                alert('더 이상 파일을 업로드할 수 없습니다. (최대 '+(file_total)+'개)');\r\n");
      ...
      out.write("\r\n");
      out.write("//////////\r\n");
      out.write("function gallery_submit() {\r\n");
      out.write("    // 1. 문서의 모든 type=\"file\" 인풋 요소를 가져옵니다.\r\n");
      out.write("    // querySelectorAll을 사용하면 'input' 태그를 모두 가져올 필요 없이 type=\"file\"만 가져올 수 있습니다.\r\n");
      out.write("    const fileInputs = document.querySelectorAll('input[type=\"file\"]');\r\n");
      out.write("    \r\n");
      out.write("    let isFileSelected = false; // 파일이 하나라도 선택되었는지 여부를 저장할 변수\r\n");
      out.write("\r\n");
      out.write("    // 2. 모든 파일 인풋을 순회하며 파일이 선택되었는지 확인합니다.\r\n");
      out.write("    for (const input of fileInputs) {\r\n");
      out.write("        // 동적으로 추가된 마지막 빈 파일 입력 필드는 무시하고, \r\n");
      out.write("        // 파일이 실제로 선택된 인풋만 확인합니다.\r\n");
      out.write("        if (input.files && input.files.length > 0) {\r\n");
      out.write("            isFileSelected = true; // 파일이 하나라도 선택되었음을 표시\r\n");
      out.write("            break; // 하나라도 찾았으면 더 이상 검사할 필요 없이 반복 중단\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 3. 파일 선택 여부에 따라 처리합니다.\r\n");
      out.write("    if (!isFileSelected) {\r\n");
      out.write("        alert(\"갤러리는 파일을 최소 1개 이상 업로드해야 합니다.\");\r\n");
      out.write("        return; // 파일이 하나도 선택되지 않았으면 폼 제출을 막습니다.\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    // 4. 모든 검증을 통과했으면 폼을 제출합니다. (name 속성 확인 완료)\r\n");
      out.write("    document.write_form.submit();\r\n");
      out.write("}\r\n");
      out.write("//////////\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
